...
Module utils
    ...
    Public IFACE_NAME As String = "Sample-BasicMI"
    ...
    Public Const INIFILE As String = "Sample-BasicMI.ini"
    ...
    Sub InitHSDevice(ByRef dv As Scheduler.Classes.DeviceClass, Optional ByVal Name As String = "Sample", Optional Instance As String = "")
